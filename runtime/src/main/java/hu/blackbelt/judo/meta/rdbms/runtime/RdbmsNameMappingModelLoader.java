...
import hu.blackbelt.judo.meta.rdbmsNameMapping.util.RdbmsNameMappingResourceImpl;
...
public class RdbmsNameMappingModelLoader {

    public static void registerRdbmsNameMappingMetamodel(ResourceSet resourceSet) {
        resourceSet.getPackageRegistry().put(RdbmsNameMappingPackage.eINSTANCE.getNsURI(), RdbmsNameMappingPackage.eINSTANCE);
    }


    public static Resource.Factory getRdbmsNameMappingFactory() {
        return new RdbmsResourceFactoryImpl() {
            @Override
            public Resource createResource(URI uri) {
                Resource result = new RdbmsNameMappingResourceImpl(uri) {
                    @Override
    ...
    public static ResourceSet createRdbmsNameMappingResourceSet() {
        return createRdbmsNameMappingResourceSet(null);
    }

    public static ResourceSet createRdbmsNameMappingResourceSet(URIHandler uriHandler) {
        ResourceSet resourceSet = new ResourceSetImpl();
        registerRdbmsNameMappingMetamodel(resourceSet);
        resourceSet.getResourceFactoryRegistry().getExtensionToFactoryMap().put(ResourceFactoryRegistryImpl.DEFAULT_EXTENSION, getRdbmsNameMappingFactory());
        if (uriHandler != null) {
    ...
    public static Resource loadRdbmsNameMappingModel(URI uri) throws IOException {
        return loadRdbmsNameMappingModel(createRdbmsNameMappingResourceSet(), uri);
    }

    public static Resource loadRdbmsNameMappingModel(ResourceSet resourceSet, URI uri) throws IOException {
        registerRdbmsNameMappingMetamodel(resourceSet);
    ...
    public static Map<Object, Object> getRdbmsNameMappingModelDefaultSaveOptions() {
    ...
    public static void saveRdbmssModel(Resource resource, URI uri) throws IOException {
        resource.save(getRdbmsNameMappingModelDefaultSaveOptions());
    }
